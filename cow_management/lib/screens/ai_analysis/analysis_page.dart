    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.water_drop, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '착유량 예측 결과',
                style: TextStyle(
            ...
            children: [
              Expanded(
                child: Container(
                  padding: const EdgeInsets.all(20),
                  decoration: BoxDecoration(
                    color: selectedService.color.withOpacity(0.1),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: selectedService.color.withOpacity(0.3)),
                  ),
                  child: Column(
                    children: [
                      Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.health_and_safety, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '유방염 위험도 분석',
                style: TextStyle(
          ...
          Container(
            ...
            padding: const EdgeInsets.all(20),
            decoration: BoxDecoration(
              color: levelColors[level - 1].withOpacity(0.1),
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: levelColors[level - 1].withOpacity(0.3)),
            ),
            child: Column(
              children: [
                Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.star, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '우유 품질 분석',
                style: TextStyle(
            ...
            children: [
              Expanded(
                child: Container(
                  padding: const EdgeInsets.all(20),
                  decoration: BoxDecoration(
                    color: gradeColors[grade]?.withOpacity(0.1),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: gradeColors[grade]?.withOpacity(0.3) ?? Colors.grey),
                  ),
                  child: Column(
                    children: [
                      Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.trending_up, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '사료 효율 분석',
                style: TextStyle(
          ...
          Container(
            ...
            padding: const EdgeInsets.all(20),
            decoration: BoxDecoration(
              color: efficiencyColors[efficiency]?.withOpacity(0.1),
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: efficiencyColors[efficiency]?.withOpacity(0.3) ?? Colors.grey),
            ),
            child: Column(
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 32,
                    fontWeight: FontWeight.bold,
                    color: efficiencyColors[efficiency],
                  ),
                ),
                const SizedBox(height: 8),
                Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.pregnant_woman, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '분만 예측 결과',
                style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.favorite, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '수정 시점 분석',
                style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.analytics, color: selectedService.color),
              const SizedBox(width: 8),
              Text(
                '분석 결과',
                style: TextStyle(
